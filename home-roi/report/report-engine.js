    ...
    var stakeholderCases = [
      {
        ...
        rationale:
          ...
          f.pay +
          ". Единая картина ИТ-активов позволяет связать решения по ПО, оборудованию и ресурсам команды с измеримым бизнес-эффектом.",
      },
      {
        role: "ИТ-директор",
        metric:
      ...
      },
      {
        role: "Финансы",
        metric:
          f.licenses + " ПО · " + f.assets + " активы · " + f.labor + " труд ИТ",
